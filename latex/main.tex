...
\abstract{When fog nodes arrive under burst load and membership change, a placement
...
\keywords{fog computing, service placement, hybrid learning, cold start, self-organizing systems, graph neural networks, CRT/GRT, iFogSim2}
