# Abstract draft (English) — DynaCol-GNN
...
**Method name in prose:** DynaCol-GNN (Vector encoder as ablation)
...
multipipe champion lock (offline weights + fine-tune, 5 trials), DynaCol-GNN
